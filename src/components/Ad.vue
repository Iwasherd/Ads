<template>
    <div class="ad">
        <div class="ad__header">
            <router-link :to="`/${ad.id}`" class="ad__title">{{ad.title}}</router-link>
            <div v-if="user && ad.autor_name === user.username" class="actions">
        ...
        <div class="ad__data">
            ...
            <div><span>Create: </span>{{ad.created_at | date}}</div>
        </div>
